...
// that gave me errors with "//" so you can see what I tried to do
// I did the same thing with the code in meal.swift
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let meal = meal {
            ...
            // instructionsTextField.text = meal.instructions
